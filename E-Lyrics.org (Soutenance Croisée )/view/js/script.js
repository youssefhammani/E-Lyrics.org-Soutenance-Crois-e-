...
function showid(id)
{
    document.getElementById('task-idd4').value = document.getElementById("id-info"+id).getAttribute('data');
}

document.getElementById("plus").onclick=()=> {
    let modalbody = document.getElementById("survey_options")
    let newdiv = document.querySelector(".all-form")
